...
func colorPrint(format string, color string, s ...any) string {
	if len(s) == 0 {
...
// SGreen 绿色字体
func SGreen(format string, s ...any) string {
	return colorPrint(format, green, s...)
}

// SWhite 白色字体
func SWhite(format string, s ...any) string {
	return colorPrint(format, white, s...)
}

// SYellow 黄色字体
func SYellow(format string, s ...any) string {
	return colorPrint(format, yellow, s...)
}

// SRed 红色字体
func SRed(format string, s ...any) string {
	return colorPrint(format, red, s...)
}

// SBlue 蓝色字体
func SBlue(format string, s ...any) string {
	return colorPrint(format, blue, s...)
}

// SMagenta 品红字体
func SMagenta(format string, s ...any) string {
	return colorPrint(format, magenta, s...)
}

// SCyan 蓝绿色
func SCyan(format string, s ...any) string {
...
// GreenBG 绿色字体
func GreenBG(format string, s ...any) {
	fmt.Print(colorPrint(format, greenBg, s...))
}

// WhiteBG 白色字体
func WhiteBG(format string, s ...any) {
	fmt.Print(colorPrint(format, whiteBg, s...))
}

// YellowBG 黄色字体
func YellowBG(format string, s ...any) {
	fmt.Print(colorPrint(format, yellowBg, s...))
}

// RedBG 红色字体
func RedBG(format string, s ...any) {
	fmt.Print(colorPrint(format, redBg, s...))
}

// BlueBG 蓝色字体
func BlueBG(format string, s ...any) {
	fmt.Print(colorPrint(format, blueBg, s...))
}

// MagentaBG 品红字体
func MagentaBG(format string, s ...any) {
	fmt.Print(colorPrint(format, magentaBg, s...))
}

// CyanBG 蓝绿色背景色
func CyanBG(format string, s ...any) {
...
// SGreenBG 绿色字体
func SGreenBG(format string, s ...any) string {
	return colorPrint(format, greenBg, s...)
}

// SWhiteBG 白色字体
func SWhiteBG(format string, s ...any) string {
	return colorPrint(format, whiteBg, s...)
}

// SYellowBG 黄色字体
func SYellowBG(format string, s ...any) string {
	return colorPrint(format, yellowBg, s...)
}

// SRedBG 红色字体
func SRedBG(format string, s ...any) string {
	return colorPrint(format, redBg, s...)
}

// SBlueBG 蓝色字体
func SBlueBG(format string, s ...any) string {
	return colorPrint(format, blueBg, s...)
}

// SMagentaBG 品红字体
func SMagentaBG(format string, s ...any) string {
	return colorPrint(format, magentaBg, s...)
}

// SCyanBG 蓝绿色背景色
func SCyanBG(format string, s ...any) string {
